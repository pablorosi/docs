...
Proceed to **[Nginx Reverse Proxy & Public SSL](/cloud-infrastructure/v1--hetzner-secure-cloud-routing-legacy/4-nginx-reverse-proxy)** to see how public web traffic is handled once it passes through this firewall.
