...
:::note[Reading order]
This chapter introduces SSH-over-Tailscale early because it is part of server provisioning. The firewall rules that block public SSH and the full Tailscale configuration are covered in **[Cloud Firewall](/cloud-infrastructure/v1--hetzner-secure-cloud-routing-legacy/3-firewall)** and **[Tailscale Private Admin Access](/cloud-infrastructure/v1--hetzner-secure-cloud-routing-legacy/5-tailscale-admin-security)**.
:::
...
Proceed to **[Cloudflare DNS & Edge Routing](/cloud-infrastructure/v1--hetzner-secure-cloud-routing-legacy/2-cloudflare-dns-routing)** to see how public traffic is directed to this server.
