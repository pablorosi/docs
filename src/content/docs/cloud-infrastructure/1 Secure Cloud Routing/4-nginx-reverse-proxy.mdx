...
Proceed to **[Tailscale Private Admin Access](/cloud-infrastructure/1-secure-cloud-routing/5-tailscale-admin-security)** to see exactly how the Nginx administrative dashboard is secured using this architecture.