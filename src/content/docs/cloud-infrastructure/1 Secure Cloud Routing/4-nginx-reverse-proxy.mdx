...
Legacy `.com` domains are **not** configured here. Their 301 redirects are handled at the Cloudflare edge — see **[Cloudflare DNS & Edge Routing](/cloud-infrastructure/1-secure-cloud-routing/2-cloudflare-dns-routing)**.
...
The NPM administrative GUI is deliberately excluded from public DNS routing to prevent Hairpin NAT loops and to enforce Zero Trust access via Tailscale. See **[Tailscale Private Admin Access](/cloud-infrastructure/1-secure-cloud-routing/5-tailscale-admin-security)**.
:::
...
Proceed to **[Tailscale Private Admin Access](/cloud-infrastructure/1-secure-cloud-routing/5-tailscale-admin-security)** for the management-plane architecture.
