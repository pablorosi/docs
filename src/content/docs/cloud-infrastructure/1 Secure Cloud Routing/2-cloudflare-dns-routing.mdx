...
description: DNS, edge proxy, and Redirect Rules for legacy domains at the Cloudflare edge.
sidebar:
  order: 2
---
...
Proceed to **[Cloud Firewall](/cloud-infrastructure/1-secure-cloud-routing/3-firewall)** to see how incoming traffic is filtered at the network layer before it reaches the operating system.
