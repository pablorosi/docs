...
Even though the Loopback is virtual, the router's CPU still works to generate those packets every 10 seconds witch are automatically discarded by the router. It's a waste of CPU cycles.
