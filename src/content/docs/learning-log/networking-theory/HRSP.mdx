...
---
Their main purpose is to provide high availability for the Default Gateway 
...
| :--- | :--- | :--- | :--- |
| **Standard Type** | Cisco Proprietary | Open Standard (IETF) | Cisco Proprietary |
| **Terminology/Roles** | Active / Standby | Master / Backup | AVG (Active Virtual Gateway) / AVF (Active Virtual Forwarder) |
| **Load Balancing** | Requires multiple groups (Per-VLAN) | Requires multiple groups (Per-VLAN) | Native / Built-in capability |
| **Virtual MAC Address** | **v1:** `0000.0C07.ACxx` **v2:** `0000.0C9F.Fxxx` | **IPv4:** `0000.5E00.01xx` **IPv6:** `0000.5E00.02xx` | `0007.B400.xxyy` |
| **Multicast IP** | **v1:** `224.0.0.2` **v2:** `224.0.0.102` | `224.0.0.18` | `224.0.0.102` |
| **Default Timers** | Hello: 3s / Hold: 10s | Hello: 1s / Dead: 3s | Hello: 3s / Hold: 10s |
