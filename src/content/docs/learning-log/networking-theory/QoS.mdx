...
The Cheat Sheet for Your Exam
If Pearson presents a drag-and-drop or a scenario question, look for these specific keywords:
DSCP / CoS / ToS → Classification and Marking
LLQ / Priority Queue / Buffering → Congestion Management
WRED / Tail Drop prevention → Congestion Avoidance
Dropping vs. Delaying (Buffering) traffic → Policing vs. Shaping
