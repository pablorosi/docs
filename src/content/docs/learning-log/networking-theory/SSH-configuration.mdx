...
```txt 
aaa authentication login disable none
``` 

`none` → This is the `method`. This is the actual functional keyword. It tells the router: "Do not ask for a password. Let anyone in."
