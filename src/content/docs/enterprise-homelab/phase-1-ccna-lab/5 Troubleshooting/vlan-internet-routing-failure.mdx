...
* **Edge gateway (GL.iNet GL-MT3000, OpenWrt):** Performs NAT for the lab. It is **directly connected** only to `192.168.8.0/24` on its LAN interface (`192.168.8.1`).
...
See **[Network Topology](/enterprise-homelab/phase-1-ccna-lab/1-architecture/network-topology)** and **[Hardware Specs](/enterprise-homelab/phase-1-ccna-lab/1-architecture/hardware-specs)** for lab context.
