...
However, according to the IEEE 802.3ab standard for Gigabit Ethernet over copper (1000BASE-T), **autonegotiation is a mandatory requirement** to establish the master/slave timing relationship between the two endpoints.
...
See **[Network Topology](/enterprise-homelab/phase-1-ccna-lab/1-architecture/network-topology)** for switch configuration context.
