...
Not yet fully documented. See **[Docker Compose](/enterprise-homelab/5-compute/docker-compose)** for the planned stack layout and **[Local SRE Platform](/local-sre-platform/)** for the observability roadmap.
